...
class ProviderDataset(Dataset):
    ...
    def __init__(self, npoints, split,
        ...
        #     else:
        #         if car_only:
        #             print("devi prasad ghar pe nahi hai line 75")
        ...
        if from_rgb_detection:
            ...
            #     print("devi ka prasad mandir mein milta hai line 87")
    ...
    def __getitem__(self, index):
        ...
        print("self.category_info.CLASSES", self.category_info.CLASSES)
        ...
        P = self.calib_list[0].reshape(3, 4) #[index]['P2'].reshape(3, 4)
        ...
        if self.from_rgb_detection:
            ...
            #print("toh tera samasya kya hai???", data_inputs)
            return data_inputs
